...
const RELATIONSHIPS = [
  ...
  { code: 'CHILD', labelKey: 'intake_relationship_child', desc_en: 'My son or daughter', desc_fil: 'Anak ko', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="5.5" r="2.5"/><path d="M9.25 11.25 12 9l2.75 2.25"/><path d="M12 9v8"/><path d="M8.75 13h6.5"/><path d="M10 19.5 12 17l2 2.5"/></svg> },
...
const MEMBERSHIP_ICONS = {
  ...
  SENIOR: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="4.5" r="2.25" fill="currentColor" stroke="none"/><path d="M11 7.75v4.25"/><path d="M11 10.25h3.5"/><path d="M14.5 10.25 16 14"/><path d="M11 12l-2.25 7"/><path d="M16.5 13v6"/><path d="M16.5 19h2"/></svg>,
  ...
  PWD: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="15.25" cy="4.75" r="1.75" fill="var(--color-success)"/><circle cx="9" cy="17" r="3.5" stroke="currentColor" strokeWidth="2"/><path d="M12.75 8.25h2.5l2 4" stroke="currentColor" strokeWidth="2"/><path d="M12.75 8.25 10.5 13" stroke="currentColor" strokeWidth="2"/><path d="M10.5 13H14a3.5 3.5 0 1 1 0 7H9" stroke="currentColor" strokeWidth="2"/></svg>,
