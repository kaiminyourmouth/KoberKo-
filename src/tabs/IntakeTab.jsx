...
const RELATIONSHIPS = [
  ...
  { code: 'CHILD', labelKey: 'intake_relationship_child', desc_en: 'My son or daughter', desc_fil: 'Anak ko', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="6.5" r="3"/><path d="M8.5 21v-3.5a3.5 3.5 0 0 1 7 0V21"/><path d="M8 13.5c1.2 1 2.55 1.5 4 1.5s2.8-.5 4-1.5"/></svg> },
